...
$sql = "SELECT Employee_ID, Employee_Name, Employee_Department, Employee_Base_Salary, Employee_Increment_Percent, Employee_Final_Salary, Last_Paid FROM employee_table";
